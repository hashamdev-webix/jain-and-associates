...
const services = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=800&q=85",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?w=800&q=85",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&q=85",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((s, i) => (
          <motion.div
            ...
            className="group rounded-4xl bg-card border border-border hover:border-brand-saffron/30 hover:shadow-brand transition-brand overflow-hidden"
          >
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 w-14 h-14 bg-white/95 backdrop-blur-sm rounded-xl flex items-center justify-center text-brand-navy shadow-lg">
                {s.icon}
              </div>
            </div>
            <div className="p-6">
    ...
    <section className="py-20 lg:py-28 bg-secondary/30">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-display font-bold text-brand-navy mb-4">How It Works</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Getting legal help is simple and straightforward. Follow these easy steps to access free legal services.
          </p>
        </div>
        <div className="space-y-6">
          {[
            { step: "01", title: "Visit or Call", desc: "Come to our nearest office or call our helpline at 123. We're available 24/7 to assist you." },
            { step: "02", title: "Meet Our Team", desc: "Our assistant will understand your case and connect you with the right lawyer who specializes in your legal matter." },
            { step: "03", title: "Get Representation", desc: "Meet the lawyer physically or connect via video call — whichever suits you best. Flexible options for your convenience." },
            { step: "04", title: "Justice Served", desc: "We fight your case at every level until justice is delivered — completely free. Your rights are our priority." },
          ].map((item, i) => (
            <motion.div
              key={i}
